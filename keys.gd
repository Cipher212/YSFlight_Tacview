...
const ACTIONS = [
	...
	["shot_5", "Shot 5: Orbit (turned only by you; where the mode starts)", KEY_5, "cinema"],
	...
	["smooth", "Smooth camera on / off (off: it sticks to the aircraft exactly)", KEY_B, "cinema"],
